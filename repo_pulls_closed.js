                    ...
                    if (i <= no_of_pages) {
                        ...
                        function getRepoDetailsByIndex(i) {
                            if (i < repositories.length) {
                                ...
                                var options = {
                                    host: 'api.github.com',
                                    path: '/repos/' + repositories[i].rep_name + '/pulls?state=closed',
                                    method: 'GET',
                                    headers: {
                                        'user-agent': 'node.js',
                                        "Authorization": auth
                                    ...
                                    resp.on("end", () => {
                                        ...
                                        function getClosedComments(p) {
                                            if (p <= no_of_closed_issues_pages) {
                                                var options2 = {
                                                    host: 'api.github.com',
                                                    path: '/repos/' + repositories[i].rep_name + '/pulls?state=closed&page=' + p,
                                                    method: 'GET',
                                                    headers: {
                                                        'user-agent': 'node.js',
                                                        "Authorization": auth
                                                ...
                                                https.get(options2, (resp1) => {
                                                    ...
                                                    resp1.on("end", () => {
                                                        ...
                                                        getCommentsByIssue(0, activity_data, function () {
                                                            ...
                                                            p++;
                                                            setTimeout(getClosedComments.bind(this, p), 1000);
                                                ...
                                                const csvWriter = createCsvWriter({
                                                    path: 'CSV files/Repository closed Pulls information/' + apiNames[a].ID + '.csv',
                                                    header: [
                                            ...
                                            res.on('end', () => {
                                                ...
                                                https.get(comments_url, options, (res) => {
                                                    ...
                                                    res.on('end', () => {
                                                        ...
                                                        if (comments_info.length == 0) {
                                                            for (d = 0; d < commits_info.length; d++) {
                                                                ...
                                                                var resultWithoutComments = {
                                                                    ...
                                                                    pull_closed_at: activity_data[y].closed_at ? activity_data[y].closed_at : "Not yet closed",
                                                        ...
                                                        y++;
                                                        setTimeout(getCommentsByIssue.bind(this, y, activity_data, onSuccess), 200);
                                                    });
